...
import com.example.application.views.partner.PartnerView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        Span appName = new Span("MoveINSA");
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(PartnerView.class)) {
            nav.addItem(new SideNavItem("Partner", PartnerView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
